    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (commandLine) {
            ...
            if ((port !== undefined) && (yield isDevServerRunning(port))) {
                ...
                process_1.startDetachedProcess(commandLine);
                if (port !== undefined) {
 ...
 */
function startDebugging(manifestPath, debuggingMethod = defaultDebuggingMethod(), sourceBundleUrlComponents, devServerCommandLine, devServerPort, packagerCommandLine, packagerHost, packagerPort, sideloadCommandLine, enableDebugging = true, enableLiveReload = true) {
    return __awaiter(this, void 0, void 0, function* () {
        let packagerPromise;
        ...
        if (enableDebugging && (debuggingMethod === office_addin_dev_settings_1.DebuggingMethod.Web)) {
            try {
