 ...
 */
export declare function startDebugging(manifestPath: string, debuggingMethod?: DebuggingMethod, sourceBundleUrlComponents?: devSettings.SourceBundleUrlComponents, devServerCommandLine?: string, devServerPort?: number, packagerCommandLine?: string, packagerHost?: string, packagerPort?: string, sideloadCommandLine?: string, enableDebugging?: boolean, enableLiveReload?: boolean): Promise<void>;
